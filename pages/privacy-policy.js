...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <Header />
      <div className="container pt-5 mb-30 mt-5">
        <p className="my-2">
          <strong>PRIVACY NOTICE</strong>
        </p>
        <p>
          This privacy notice for Weeple Logistics Platform LLP (doing business
          as Weeple) ("<strong>Weeple</strong>," "<strong>we</strong>," "
        ...
        <ul>
          <li>
            Visit our website at Weeple.com, or any website of ours that links
        ...
        <p className="my-2">
          ...
          us at support[ at ]weeple[ dot ]in.
        </p>
        <p className="my-2">
        ...
        <p className="my-2">
          ...
          information depending on how you interact with Weeple and the
        ...
        <p className="my-2">
          ...
          available here: Mail on support[ at ]weeple[ dot ]in, or by contacting
          us. We will consider and act upon any request in accordance with
          applicable data protection laws.
        </p>
        <p>
          Want to learn more about what Weeple does with any information we
        ...
        <p>
          ...
          please contact us at support[ at ]weeple[ dot ]in.
        </p>
        <ol start={6}>
          <li>
        ...
        <p>
          ...
          email us at support[ at ]weeple[ dot ]in.
        </p>
        <ol start={7}>
          <li>
        ...
        <p>
          ...
          at support[ at ]weeple[ dot ]in or by post to:
        </p>
        <p>Weeple Logistics Platform LLP</p>
        <p>support[ at ]weeple[ dot ]in</p>
        <p>support[ at ]weeple[ dot ]in</p>
        <ol start={11}>
          <li>
            <strong>
        ...
        <p>
          ...
          or delete your personal information, please visit: Mail on support[ at
          ]weeple[ dot ]in.
        </p>
      </div>
      <Footer />
