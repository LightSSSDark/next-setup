function Footer() {
  return (
    <footer
      className="fugu-footer-section style="
      style={{
        backgroundImage: 'url("assets/images/all-img/v4/footer-bg.png")',
      }}
    >
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="fugu-textarea">
              ...
              <p>
                Airygo is a brand of Weeple Logistics Solution Private Limited,
                offering customers the convenience of access to hundreds of
                logistics companies worldwide. Manage air freight & air cargo
                bookings with ease, featuring global forwarding, door pickup/
                delivery, live tracking and more!
              </p>
              <p className="fugu-copywright">
                © Copyright 2023, All Rights Reserved by Airygo
              </p>
            </div>
          </div>
          <div className="footer-blog col-lg-4 col-md-4 col-sm-4">
          ...
          <div className="col-lg-4 col-md-4 col-sm-4">
            <div className="fugu-footer-menu">
              ...
              <p>
                ...
                Temporibus asperiores repellat, suscipit nihil quia reiciendis,
                autem eligendi ullam doloremque quaerat quis recusandae amet
                dicta, natus dolores aperiam porro fugit consequuntur?
              </p>
            </div>
